...
CREATE OR REPLACE FUNCTION task_attribute_type__update (
    a_id integer,
    a_name varchar,
...
BEGIN
    ...
    BEGIN
        ...
        IF user_is_admin ( a_session_username ) THEN
            ...
            UPDATE tasker.rt_task_attribute_type
...
ALTER FUNCTION task_attribute_type__update (
    integer,
    varchar,
    varchar,
    boolean,
...
GRANT ALL ON FUNCTION task_attribute_type__update (
    integer,
    varchar,
    varchar,
    boolean,
...
REVOKE ALL ON FUNCTION task_attribute_type__update (
    integer,
    varchar,
    varchar,
    boolean,
