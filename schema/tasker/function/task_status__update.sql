...
CREATE OR REPLACE FUNCTION tasK_status__update (
    a_id integer,
    a_name varchar,
...
ALTER FUNCTION tasK_status__update (
    integer,
    varchar,
    varchar,
    integer,
...
GRANT ALL ON FUNCTION tasK_status__update (
    integer,
    varchar,
    varchar,
    integer,
...
REVOKE ALL ON FUNCTION tasK_status__update (
    integer,
    varchar,
    varchar,
    integer,
