...
CREATE TABLE rt_activity_attribute_type (
    ...
    CONSTRAINT rt_activity_attribute_type_pk PRIMARY KEY ( id ),
    CONSTRAINT rt_activity_attribute_type_ix1 UNIQUE ( category_id, name ) ) ;

ALTER TABLE rt_activity_attribute_type OWNER TO tasker_owner ;
