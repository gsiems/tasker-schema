...
CREATE OR REPLACE FUNCTION task_type__insert (
...
BEGIN
    ...
    BEGIN
        ...
        IF user_is_admin ( a_session_username ) THEN
            ...
            WITH a AS (
                INSERT INTO tasker.rt_task_type (
                        id,
                        category_id,
                        name,
                        description,
                        ...
                        created_by,
                        created_dt )
                    SELECT nextval ( 'rt_task_type_id_seq' ),
                            a_category_id,
                            trim ( a_name ),
                            trim ( a_description ),
                            a_is_enabled,
...
ALTER FUNCTION task_type__insert (
    integer,
    varchar,
    varchar,
    boolean,
...
GRANT ALL ON FUNCTION task_type__insert (
    integer,
    varchar,
    varchar,
    boolean,
...
REVOKE ALL ON FUNCTION task_type__insert (
    integer,
    varchar,
    varchar,
    boolean,
