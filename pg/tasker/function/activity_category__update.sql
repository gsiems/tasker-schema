...
CREATE OR REPLACE FUNCTION activity_category__update (
    a_id integer,
    a_name varchar,
...
BEGIN
    ...
    BEGIN
        ...
        IF user_is_admin ( a_session_username ) THEN
            ...
            UPDATE tasker.rt_activity_category
...
ALTER FUNCTION activity_category__update (
    integer,
    varchar,
    varchar,
    boolean,
...
GRANT ALL ON FUNCTION activity_category__update (
    integer,
    varchar,
    varchar,
    boolean,
...
REVOKE ALL ON FUNCTION activity_category__update (
    integer,
    varchar,
    varchar,
    boolean,
