...
CREATE OR REPLACE FUNCTION task_type__update (
    a_id integer,
    a_name varchar,
...
ALTER FUNCTION task_type__update (
    integer,
    varchar,
    varchar,
    boolean,
...
GRANT ALL ON FUNCTION task_type__update (
    integer,
    varchar,
    varchar,
    boolean,
...
REVOKE ALL ON FUNCTION task_type__update (
    integer,
    varchar,
    varchar,
    boolean,
